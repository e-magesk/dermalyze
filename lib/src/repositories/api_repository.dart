...
class ApiRepository {
  ...
  Future<void> uploadCase(ClinicalRecord record, InferenceResult result) async {
    ...
    request.fields['family_skin_cancer_history'] = _tripleToStr(record.history);
    ...
    request.fields['ai_label'] = result.label;
    request.fields['ai_confidence'] = result.confidence.toString();
    request.fields['ai_type'] = result.type.name;
